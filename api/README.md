# Sample App using DDD, Serverless, NestJS, MySQL

이 프로젝트는 스타벅스 개발 3팀이 고민하고 있는 스택을 최대한 유사하게 구축한 상태에서 Event Driven App, Severless Application의 권고안을 만들어 내기 위해서 작성된 앱이다. 
